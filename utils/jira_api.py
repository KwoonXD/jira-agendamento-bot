...
class JiraAPI:
    ...
    def buscar_chamados_enhanced(
        ...
        """Mantido por compatibilidade; encaminha para o método paginado."""

        return self.buscar_chamados_jql_paginado(
            jql,
            fields=fields,
            page_size=page_size,
            reconcile=reconcile,
    ...
    def buscar_chamados_jql_paginado(
        self,
        jql: str,
        fields: Union[str, List[str]],
        page_size: int = 100,
