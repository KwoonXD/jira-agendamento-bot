...
class JiraAPI:
    ...
    Suporta dois modos de chamada:
      - Modo domínio: https://<site>.atlassian.net/rest/api/3/...
      - Modo EX API:  https://api.atlassian.com/ex/jira/{cloudId}/rest/api/3/...
    Use EX API para tokens fine‑grained.
    """
    ...
    def __init__(
        ...
        email: str,
        api_token: str,
        jira_url: str,                 # ex.: https://delfia.atlassian.net (ainda usado p/ tenant_info)
    ...
    def _auth_headers(self) -> Dict[str, str]:
        if not self.use_ex_api:
            return {}
        # Para EX API, vamos mandar Authorization manualmente
